...
var config = {
  apiOrigins: {
    ...
    production: 'https://murmuring-beyond-57422.herokuapp.com'
  }
};
...
var onCreateExercise = function onCreateExercise(event) {
  ...
  // console.log(data)
  api.create(data).then(ui.createExerciseSuccess).then(onGetExercises).catch(ui.createExerciseFailure);
};
...
var onGetExercises = function onGetExercises(event) {
  ...
  api.index().then(ui.getExercisesSuccess).catch(ui.getExercisesfailure);
};

var onShowAddExercise = function onShowAddExercise() {
  $('#app-message').hide();
  $('#all-exercises-page').hide();
  $('#new-exercise-page').show('swing');
};

var onHideAddExercise = function onHideAddExercise() {
  $('#app-message').hide();
...
var onHideEditExercise = function onHideEditExercise() {
  $('#app-message').hide();
  $('#edit-exercise-page').hide();
  $('#all-exercises-page').show('swing');
};

var onShowEditExercise = function onShowEditExercise(event) {
  var exerciseId = event.target.getAttribute('data-id');
  // console.log('exerciseID', exerciseId)
  onGetExerciseById(exerciseId);
  $('#app-message').hide();
};

var onGetExerciseById = function onGetExerciseById(exerciseId) {
  event.preventDefault();
  api.show(exerciseId).then(ui.showExerciseSuccess).catch(ui.showExerciseFailure);
};

var onUpdateExercise = function onUpdateExercise(event) {
  event.preventDefault();
  var formData = getFormFields(event.target);
  api.update(formData).then(ui.updateExerciseSuccess).then(onGetExercises).catch(ui.updateExerciseFailure);
};

var onDeleteExercise = function onDeleteExercise(event) {
  event.preventDefault();
  api.destroy().then(ui.deleteExerciseSuccess).then(onGetExercises).catch(ui.deleteExerciseFailure);
};
...
var exerciseEvents = __webpack_require__(7);
...
var onSignIn = function onSignIn(event) {
  ...
  event.preventDefault();
  // console.log(data)
  api.signIn(data).then(ui.signInSuccess).then(exerciseEvents.onGetExercises).catch(ui.signInFailure);
};
...
var store = __webpack_require__(3);
var showExercisesTemplate = __webpack_require__(20);
var showEditExerciseTemplate = __webpack_require__(37);
...
var createExerciseFailure = function createExerciseFailure() {
  // console.error(error)
  $('#app-message').show();
...
var getExercisesfailure = function getExercisesfailure() {
  // console.error(error)
  $('#app-message').show();
  $('#app-message').text('Oops! Something went wrong. Please try again.');
};

var showExerciseSuccess = function showExerciseSuccess(data) {
  store.exercise = data.exercise;
  $('#all-exercises-page').hide();
  $('#app-message').hide();
  $('#edit-exercise-page').show('swing');
  // console.log('show exercise data is', data)
  var showEditExerciseHtml = showEditExerciseTemplate({ exercise: data.exercise });
  $('#edit-exercise-content').show();
  $('#edit-exercise-content').html(showEditExerciseHtml);
};

var showExerciseFailure = function showExerciseFailure() {
...
var updateExerciseFailure = function updateExerciseFailure() {
  // console.log(error)
  $('#app-message').show();
  $('#app-message').text('Oops! Something went wrong. Please try again. Please note that some fields are required.');
};

var deleteExerciseSuccess = function deleteExerciseSuccess() {
  store.exercise = {};
...
var deleteExerciseFailure = function deleteExerciseFailure() {
  // console.log(error)
  $('#app-message').show();
  $('#app-message').text('Oops! Something went wrong. Please try again.');
};
...
module.exports = {
  ...
  getExercisesfailure: getExercisesfailure,
  showExerciseSuccess: showExerciseSuccess,
  showExerciseFailure: showExerciseFailure,
  updateExerciseSuccess: updateExerciseSuccess,
  updateExerciseFailure: updateExerciseFailure,
  deleteExerciseSuccess: deleteExerciseSuccess,
  deleteExerciseFailure: deleteExerciseFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.exercises : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"2":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

  return "<a data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"list-group-item list-color\">\n  <h4 data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    ...
    + " lbs\n  </p>\n"
    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? stack1.notes : stack1),{"name":"if","hash":{},"fn":container.program(3, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "</a>\n";
},"3":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

  return "  <small data-id=\""
    ...
    return "<h4 class=\"no-exercises\">You currently do not have any exercises listed</h4>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.exercises : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0, blockParams),"inverse":container.program(5, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"form-group row\">\n <label class=\"col-2\">Name<span class=\"asterisk\"> *</span></label>\n <div class=\"col-10\">\n   <input class=\"app-form form-control form-control-lg\" type=\"text\" name=\"exercise[name]\" value=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.exercise : depth0)) != null ? stack1.name : stack1), depth0))
    + "\">\n</div>\n</div>\n\n<div class=\"form-group row\">\n <label for=\"example-text-input\" class=\"col-2\">Weight per Set (lbs)<span class=\"asterisk\"> *</span></label>\n <div class=\"col-10\">\n<div class=\"col-10\">\n<input class=\"app-form form-control form-control-lg\" type=\"number\" name=\"exercise[weight]\" value=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.exercise : depth0)) != null ? stack1.weight : stack1), depth0))
    + "\" min=\"0\">\n</div>\n</div>\n</div>\n\n<div class=\"form-group row\">\n<label for=\"example-text-input\" class=\"col-2\"># of Sets<span class=\"asterisk\"> *</span></label>\n<div class=\"col-10\">\n<div class=\"col-10\">\n<input class=\"app-form form-control form-control-lg\" type=\"number\" name=\"exercise[sets]\" value=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.exercise : depth0)) != null ? stack1.sets : stack1), depth0))
    + "\" min=\"0\">\n</div>\n</div>\n</div>\n\n<div class=\"form-group row\">\n<label for=\"example-text-input\" class=\"col-2\">Repetitions<span class=\"asterisk\"> *</span></label>\n<div class=\"col-10\">\n<div class=\"col-10\">\n<input class=\"app-form form-control form-control-lg\" type=\"number\" name=\"exercise[reps]\" value=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.exercise : depth0)) != null ? stack1.reps : stack1), depth0))
    + "\" min=\"0\">\n</div>\n</div>\n</div>\n\n<div class=\"form-group row\">\n<label for=\"example-text-input\" class=\"col-2\">Notes</label>\n<div class=\"col-10\">\n<div class=\"col-10\">\n<input class=\"app-form form-control form-control-lg\" type=\"text\" name=\"exercise[notes]\" value=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.exercise : depth0)) != null ? stack1.notes : stack1), depth0))
    + "\">\n</div>\n</div>\n</div>\n";
},"useData":true});
